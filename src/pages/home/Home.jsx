...
function Home() {
  ...
  const mainFeatures = Object.keys(FEATURE_CONFIG)
  ...
  const authSection = {
    ...
    icon: currentUser ? teamsConfig.icon : teamsConfig.lockedIcon,
    link: currentUser ? teamsConfig.link : "/login",
    color: currentUser ? teamsConfig.color : teamsConfig.lockedColor,
  };
