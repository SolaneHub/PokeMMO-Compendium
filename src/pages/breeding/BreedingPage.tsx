...
function BreedingPage() {
  ...
  const [nature, setNature] = usePersistentState<boolean>(
    "breeding_nature",
    false
  );
  const [selectedIvStats, setSelectedIvStats] = usePersistentState<string[]>(
    "breeding_ivStats",
    IV_STATS
  );
  ...
  return (
    <PageLayout title="Breeding Planner" accentColor={accentColor}>
      ...
      {/* Controls Container */}
      <div className="grid animate-[fade-in_0.3s_ease-out] grid-cols-1 gap-6 text-white lg:grid-cols-3">
        {/* Configuration Panel */}
