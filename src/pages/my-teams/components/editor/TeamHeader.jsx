  ...
  return (
    <div className="animate-fade-in sticky top-4 z-40 mb-6 flex items-center justify-between rounded-xl border border-white/5 bg-[#0f1014] p-4 shadow-2xl backdrop-blur-md">
      ...
      <button
        onClick={onSave}
        disabled={saving}
        className="flex items-center gap-2 rounded-lg bg-blue-600 px-6 py-2 text-sm font-bold text-white shadow-lg shadow-blue-900/20 transition-all hover:bg-blue-500 active:scale-95 disabled:opacity-50"
      >
        <Save size={18} />
