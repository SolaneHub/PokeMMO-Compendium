...
import { eliteFourMembers } from "@/utils/eliteFourMembers";
...
const UserTeamEditorPage = () => {
        ...
        <div className="mx-auto w-full max-w-6xl space-y-10">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            ...
            <div className="space-y-2">
              ...
              <input
                type="text"
                className="placeholder:/20 w-full min-w-[300px] border-b-2 border-white/5 bg-transparent px-0 py-2 text-4xl font-black transition-colors focus:border-blue-400 focus:outline-none"
                value={team.name}
  ...
  return (
    <div className="animate-fade-in flex h-full flex-1 overflow-hidden bg-[#1a1b20]">
      ...
      {/* 1. Sidebar */}{" "}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-80 transform transition-transform duration-300 lg:static lg:h-full lg:translate-x-0 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        {" "}
        <EditorSidebar
          team={team}
