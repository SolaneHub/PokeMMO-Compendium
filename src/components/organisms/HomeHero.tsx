function HomeHero() {
  return (
    <section className="relative w-full flex-shrink-0 overflow-hidden rounded-3xl border border-white/5 bg-gradient-to-br from-[#1e2025] to-[#15161a] p-8 text-white shadow-2xl md:p-12">
