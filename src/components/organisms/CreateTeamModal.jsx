            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-white/10 bg-[#0f1014] p-3 transition-colors outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                  autoFocus
                  required
                />{" "}
              </div>{" "}
