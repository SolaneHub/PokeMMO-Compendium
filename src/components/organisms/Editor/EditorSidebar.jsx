  ...
  return (
    <div className="mb-2">
      ...
      <button
        ...
        className="hover: flex w-full items-center justify-between rounded-md px-2 py-1.5 text-xs font-semibold tracking-wider text-slate-500 uppercase hover:bg-white/5"
      >
        {" "}
...
const SidebarItem = ({ active, onClick, children, icon: Icon, actions }) => (
  <div
    className={`group flex cursor-pointer items-center justify-between rounded-md border px-3 py-2 text-sm transition-colors duration-200 ${active ? "border-blue-500/20 bg-blue-600/10 text-blue-400" : "hover: border-transparent hover:bg-white/5"}`}
    onClick={onClick}
  >
    {" "}
  ...
  return (
    ...
    >
      ...
      <div className="custom-scrollbar flex-1 overflow-y-auto p-3">
        ...
        <div className="h-4" /> {/* Section: Roster */}{" "}
        ...
        <div className="h-4" /> {/* Section: Strategies */}{" "}
        <SidebarSection title="Battle Plans" icon={Swords}>
          ...
          {regions.map((region) => (
            <div key={region} className="mb-1">
              {" "}
              <div
                className="hover: flex cursor-pointer items-center gap-2 px-2 py-1 text-sm"
                  ...
                  {availableMembers
                    ...
                    .map((member) => (
                      <div key={member.name} className="mb-1">
                        {" "}
                        <div
                          className="hover: flex cursor-pointer items-center gap-2 py-1 text-sm"
