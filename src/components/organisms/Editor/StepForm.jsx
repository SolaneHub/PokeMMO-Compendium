    ...
    <div className="mt-2 space-y-4">
      ...
      <div className="relative">
        ...
        <textarea
          ...
          className="w-full resize-y rounded-xl border border-white/10 bg-[#0f1014] px-4 py-3 text-sm font-medium transition-all outline-none focus:border-blue-500 focus:bg-[#0f1014]/50"
        ...
        <div className="mt-2 flex flex-wrap items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            {!showWarning && (
              ...
              >
                {" "}
                <AlertTriangle size={12} /> Add Warning{" "}
              </button>
            )}{" "}
            <button
              type="button"
              onClick={() => setShowAdvanced(!showAdvanced)}
              className={`flex cursor-pointer items-center gap-1 rounded px-2 py-1 text-[10px] font-bold uppercase transition-colors ${showAdvanced ? "bg-purple-500/10 text-purple-400" : "text-slate-500 hover:bg-white/5 hover:text-purple-400"}`}
            >
              {" "}
              <GitBranch size={12} />{" "}
        ...
        <div className="animate-fade-in rounded-xl border border-dashed border-purple-500/20 bg-purple-500/5 p-4">
          ...
          <div className="mb-4 flex items-center justify-between">
            ...
            <h4 className="flex items-center gap-2 text-[10px] font-black tracking-[0.2em] text-purple-400 uppercase">
              {" "}
              <GitBranch size={12} /> Branching Scenarios{" "}
            </h4>{" "}
            <button
              type="button"
