    ...
    <div className="animate-fade-in flex flex-col rounded-xl border border-white/5 bg-[#111216] p-6 shadow-sm">
      ...
      <div className="flex flex-1 animate-[fade-in_0.3s_ease-out] flex-col">
        ...
        <form id="pokemon-form" onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="text"
                    required
                    className="w-full rounded-lg border border-white/5 bg-[#0a0b0e] p-3 transition-colors focus:border-blue-400 focus:outline-none"
          ...
          <div className="h-px bg-white/5" /> {/* Section: Stats */}{" "}
          <div>
            {" "}
            <h3 className="mb-4 text-sm font-bold tracking-wider text-blue-400 uppercase">
              {" "}
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  list="natures-list"
                  type="text"
                  className="w-full rounded-lg border border-white/5 bg-[#0a0b0e] p-2.5 focus:border-blue-400 focus:outline-none"
          ...
          <div className="h-px bg-white/5" /> {/* Section: Moves */}{" "}
          <div>
            {" "}
            <h3 className="mb-4 text-sm font-bold tracking-wider text-blue-400 uppercase">
              {" "}
              ...
              {formData.moves.map((move, idx) => (
                <div key={idx} className="relative">
                  ...
                  <input
                    list="moves-list"
                    type="text"
                    className="w-full rounded-lg border border-white/5 bg-[#0a0b0e] p-2.5 pl-8 focus:border-blue-400 focus:outline-none"
