...
const TeamHeader = ({
  ...
  return (
    <div className="animate-fade-in sticky top-4 z-40 mb-6 flex items-center justify-between rounded-xl border border-white/5 bg-[#0f1014] p-4 text-white shadow-2xl backdrop-blur-md">
