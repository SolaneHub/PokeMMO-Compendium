        ...
        >
          ...
          <div className="flex flex-col gap-4">
            ...
            {strategyHistory.length > 0 && (
              <button
                className="group hover: mb-2 flex items-center gap-2 self-start rounded-lg border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium transition-all hover:bg-white/10"
                onClick={onBack}
              >
                {" "}
                <ArrowLeft size={16} className="group-hover:opacity-100" />{" "}
                <span>Back</span>{" "}
              </button>
            )}{" "}
                  ...
                  >
                    ...
                    {(item.type === "main" || item.type === "step") && (
                      <>
                        ...
                        {item.player && (
                          <div
                            className={`mb-3 rounded-xl border p-4 ${item.type === "main" ? "border-white/5 bg-[#25272e] shadow-sm" : "border-transparent bg-transparent"}`}
                          >
                            {" "}
