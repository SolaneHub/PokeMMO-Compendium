  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2.5">
        {" "}
        <p className="m-0 rounded-lg border-l-4 border-blue-600 bg-white/5 p-3 text-sm leading-relaxed italic">
          {" "}
          {pokemon.description}{" "}
        </p>{" "}
      </div>{" "}
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <InfoCard label="Egg Group" value={pokemon.eggGroups?.join(", ")} />{" "}
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <InfoCard
            label="Held Item"
            value={
              Array.isArray(pokemon.heldItems) && pokemon.heldItems.length > 0
