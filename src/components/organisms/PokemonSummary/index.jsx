    ...
    >
      ...
      >
        ...
        <div className="relative flex shrink-0 flex-col items-center border-b border-white/5 bg-[#0f1014] p-5">
          {" "}
          <button className="hover: absolute top-4 right-4 rounded-md border border-white/10 bg-[#1a1b20] px-3 py-1.5 text-xs font-semibold transition-colors hover:border-blue-600">
            {" "}
            🔊 Cry{" "}
          </button>{" "}
          <img
