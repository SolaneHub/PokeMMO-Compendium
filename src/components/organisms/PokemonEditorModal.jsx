            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div className="group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="text"
                    required
                    className="w-full rounded-lg border border-white/10 bg-[#0f1014] p-3 pl-10 transition-colors focus:border-blue-500 focus:outline-none"
              ...
              <div>
                ...
                <input
                  list="items-list"
                  type="text"
                  className="w-full rounded-lg border border-white/10 bg-[#0f1014] p-3 transition-colors focus:border-blue-500 focus:outline-none"
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  list="abilities-list"
                  type="text"
                  className="w-full rounded-lg border border-white/10 bg-[#0f1014] p-2.5 focus:border-blue-500 focus:outline-none"
                ...
                {formData.moves.map((move, idx) => (
                  <div key={idx} className="relative">
                    ...
                    <input
                      list="moves-list"
                      type="text"
                      className="w-full rounded-lg border border-white/10 bg-[#0f1014] p-2.5 pl-8 focus:border-blue-500 focus:outline-none"
